...
Ext.define('Ext.ux.colorpicker.ColorPicker', {
	...
	updateColor : function() {
		var me = this, hsv = me.getHsv();
		var rgb = me.hsvToRgb(hsv.h * 360, hsv.s, hsv.v);
		...
		if (me.updateMode != 'hsv') {
			me.down('#iHue').setValue(Math.round(hsv.h * 360));
		...
		me.fireEvent('update', this, me.rgbToHex(rgb));
	},
